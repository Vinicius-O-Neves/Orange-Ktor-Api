...
class InMemoryToRepository: ItemsRepository {
    ...
    private val items = listOf<FoodModel>(
        FoodModel(
            ...
            "Hambúgueres",
            "27",
            "Um delicioso lanche com um hambúrguer bovino de 180g, duas fatias de queijo cheddar, tomate, alface!! Uhmm acompanhado com um cesto de fritas.",
        ...
        FoodModel(
            ...
            "Hambúgueres",
            "33",
            "Um delicioso lanche com um hambúrguer bovino de 180g, duas fatias de queijo cheddar, tomate, alface, picles, cebola, maionese e fatias crocantes de bacon!! Uhmm acompanhado com um cesto de fritas.",
        ...
        FoodModel(
            ...
            "Hambúgueres",
            "45",
            "Um delicioso lanche com dois hambúrgueres bovinos de 180g, três fatias de queijo cheddar, tomate, alface, picles, cebola, maionese e fatias crocantes de bacon!! Uhmm acompanhado com um cesto de fritas.",
        ...
        FoodModel(
            ...
            "Hambúgueres",
            "32",
            "Um delicioso lanche com um frango empanado de 180g, três fatias de queijo cheddar, tomate, alface, picles, cebola, muita maionese!! Uhmm acompanhado com um cesto de fritas.",
